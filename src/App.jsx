  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <p>When a company like Reliance Industries or TCS lists on the stock exchange, it divides itself into millions of small pieces called <strong style={{color:'var(--text)',fontWeight:500}}>shares</strong>. Buying a share means you own a tiny fraction of that company. If the company grows, your share is worth more. If it struggles, worth less.</p>
      </div>
  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <p>An option is a <strong style={{color:'var(--text)',fontWeight:500}}>contract</strong> between two parties that gives the buyer the <strong style={{color:'var(--text)',fontWeight:500}}>right (but not the obligation)</strong> to buy or sell an underlying asset at a <strong style={{color:'var(--text)',fontWeight:500}}>predetermined price</strong>, before or on a <strong style={{color:'var(--text)',fontWeight:500}}>specified date</strong>.</p>
      </div>
      ...
      <div className="glossary-grid">
        ...
        <div className="gitem"><div className="gt">Expiry Date</div><div className="gd">The deadline. After this date, the option ceases to exist. In India, typically the last Thursday of each month.</div></div>
        <div className="gitem"><div className="gt">Lot Size</div><div className="gd">Options trade in fixed lots (e.g., 1 lot of Nifty = 75 units). You cannot buy a fraction of a lot.</div></div>
      </div>
      ...
      <div className="grid2">
        <div className="card call">
          ...
          <p>Right to <strong style={{color:'var(--text)',fontWeight:500}}>buy</strong> the stock at the strike price. You profit when the price goes <strong style={{color:'var(--teal)',fontWeight:500}}>up</strong>.</p>
        </div>
        <div className="card put">
          <Tag type="put">Put</Tag>
          <div className="card-title">PUT Option</div>
          <p>Right to <strong style={{color:'var(--text)',fontWeight:500}}>sell</strong> the stock at the strike price. You profit when the price goes <strong style={{color:'var(--red)',fontWeight:500}}>down</strong>.</p>
        </div>
      </div>
    </>
  )
  ...
  return (
    <>
      ...
      <div className="card call">
        ...
        <p>You believe Stock XYZ (currently ₹500) will rise in the next month. Instead of buying the actual stock, you buy a <strong style={{color:'var(--teal)',fontWeight:500}}>call option</strong> with a strike price of ₹520, paying a premium of ₹15.</p>
      </div>
  ...
  return (
    <>
      ...
      <div className="card put">
        ...
        <div className="card-title">The simple setup</div>
        <p>You believe Stock XYZ (currently ₹500) will fall in the next month. You buy a <strong style={{color:'var(--red)',fontWeight:500}}>put option</strong> with a strike price of ₹480, paying a premium of ₹12.</p>
      </div>
      ...
      <div className="card">
        ...
        <p style={{marginTop:'10px'}}>Puts are also used as <strong style={{color:'var(--text)',fontWeight:500}}>portfolio insurance</strong>. If you already own a stock, a put protects you if prices crash — it's like a fire insurance policy for your investment.</p>
      </div>
    </>
  )
}
    ...
    <>
      ...
      <div className="card call">
        ...
        <div className="metric-row" style={{marginTop:'12px'}}>
          <Metric label="Market outlook" val="Bullish ↑" color="green" />
      ...
      <div className="card sell">
        <Tag type="sell">Sell Call — Short Call / Write Call</Tag>
        <div className="card-title">You collect premium → you carry the obligation</div>
        <p>You sell someone else a call option. You <strong style={{color:'var(--text)',fontWeight:500}}>collect</strong> the premium upfront. But now you are <em>obligated</em> to sell them the stock at the strike price if they exercise. If the stock surges past your strike, your loss can be unlimited.</p>
        <div className="metric-row" style={{marginTop:'12px'}}>
          <Metric label="Market outlook" val="Bearish / Flat ↓→" color="red" />
  ...
  return (
    <>
      ...
      <div className="card put">
        ...
        <p>You believe the stock will fall. If it crashes, you profit handsomely. If it rises or stays flat, you lose only the premium — a capped, known loss. Puts are also used to hedge an existing stock position.</p>
        <div className="metric-row" style={{marginTop:'12px'}}>
          <Metric label="Market outlook" val="Bearish ↓" color="red" />
          <Metric label="Max loss" val="Premium" color="red" />
      ...
      <div className="card sell">
        <Tag type="sell">Sell Put — Short Put / Write Put</Tag>
        <div className="card-title">You collect premium → you carry the obligation to buy</div>
        <p>You sell a put option. You collect the premium now. But you are <em>obligated</em> to buy their stock at the strike price if they exercise. If the stock crashes, you're forced to buy at a high price — potentially a very large loss.</p>
        <div className="metric-row" style={{marginTop:'12px'}}>
          <Metric label="Market outlook" val="Bullish / Flat ↑→" color="green" />
          <Metric label="Max gain" val="Premium" color="green" />
  ...
  return (
    <div className="app">
      <header>
        ...
        <span className="header-tag">NSE · Indian Markets · Nifty</span>
      </header>
      ...
      <main className="content">
        <nav className="chapter-nav" aria-label="Chapters">
          {CHAPTERS.map((ch, i) => (
            <button
              key={i}
              className={`ch-btn ${active === i ? 'active' : ''}`}
              onClick={() => setActive(i)}
            >
        ...
        <div style={{display:'flex', justifyContent:'space-between', marginTop:'2.5rem', gap:'8px'}}>
          {active > 0 && (
            <button
              ...
              style={{fontFamily:'var(--mono)', fontSize:'12px', padding:'8px 16px', border:'1px solid var(--border2)', borderRadius:'var(--radius)', background:'var(--bg2)', color:'var(--text2)', cursor:'pointer'}}
            >
          ...
          {active < CHAPTERS.length - 1 && (
            <button
              onClick={() => setActive(a => a + 1)}
              style={{fontFamily:'var(--mono)', fontSize:'12px', padding:'8px 16px', border:'1px solid var(--gold)', borderRadius:'var(--radius)', background:'var(--gold-dim)', color:'var(--gold)', cursor:'pointer'}}
            >
              {CHAPTERS[active+1].label} →
            </button>
          )}
      ...
      <footer>
        <p>Options Academy · Built with React + Vite · Deployed on Vercel</p>
